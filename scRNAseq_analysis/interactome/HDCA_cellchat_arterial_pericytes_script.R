setwd()
wd <- "C:/Users/alex/Desktop/cellchat_arterial_pericyte03/"
...
lung <- subset(lung, ident= c("mes_cl4", "mes_cl10", "mes_cl14", "endo_cl0", "endo_cl1", "endo_cl12", "endo_cl6", "endo_cl9"))
levels(lung) <- c("mes_cl4", "mes_cl10", "mes_cl14","endo_cl0", "endo_cl1", "endo_cl12", "endo_cl6", "endo_cl9")
...
max_value <- data.frame(apply(m[, 2:9], 1, max))
...
# The function computeAveExpr can help to check the average expression of signaling genes of interest, e.g, FGF20 and BMP2
...
# obtain the order of the clusters, to select the ones of interest
rownames(cellchat@netP[["prob"]])
netVisual_bubble(cellchat, sources.use = c(4,7), targets.use = c(1,3), remove.isolate = FALSE, thresh = 0.001)

# show all the significant interactions (L-R pairs) associated with certain signaling pathways
pathways.show.all <- cellchat@netP$pathways
netVisual_bubble(cellchat, sources.use = c(4,7), targets.use = c(1,3), signaling = pathways.show.all, remove.isolate = FALSE,thresh = 0.001)

pdf("pathways_LR_probability_dotplot_endo_target.pdf",width = 3, height = 15, paper = "special")
a<- netVisual_bubble(cellchat, sources.use = c(1,3), targets.use = c(4,7), signaling = pathways.show.all, remove.isolate = FALSE,thresh = 0.001,font.size = 8)
print(a)
rm(a)
dev.off()

pdf("pathways_LR_probability_dotplot_mes_target.pdf",width = 3, height = 15, paper = "special")
a<- netVisual_bubble(cellchat, sources.use = c(4,7), targets.use = c(1,3), signaling = pathways.show.all, remove.isolate = FALSE,thresh = 0.001,font.size = 8)
print(a)
rm(a)
dev.off()

pdf("pathways_LR_probability_dotplot_endo.pdf",width = 3, height = 15, paper = "special")
a<- netVisual_bubble(cellchat, sources.use = c(4,7), targets.use = c(4,7), signaling = pathways.show.all, remove.isolate = FALSE,thresh = 0.001,font.size = 8)
print(a)
rm(a)
dev.off()

pdf("pathways_LR_probability_dotplot_mes.pdf",width = 3, height = 15, paper = "special")
a<- netVisual_bubble(cellchat, sources.use = c(1,3), targets.use = c(1,3), signaling = pathways.show.all, remove.isolate = FALSE,thresh = 0.001,font.size = 8)
print(a)
rm(a)
dev.off()
...
pdf("significant_pathways_from_endo_chordplot.pdf",width = 12, height = 12, paper = "special")
a<- netVisual_chord_gene(cellchat, sources.use = c(4,7), targets.use = c(1,3), slot.name = "netP", legend.pos.x = 10)
print(a)
rm(a)
dev.off()

pdf("significant_pathways_from_mes_chordplot.pdf",width = 12, height = 12, paper = "special")
a<- netVisual_chord_gene(cellchat, sources.use = c(1,3), targets.use = c(4,7), slot.name = "netP", legend.pos.x = 10)
print(a)
rm(a)
dev.off()
...
a<- netAnalysis_signalingRole_heatmap(cellchat, pattern = "outgoing",width = 3, height = 15)
print(a)
rm(a)
dev.off()
...
a<- netAnalysis_signalingRole_heatmap(cellchat, pattern = "incoming",width = 3, height = 15)
print(a)
rm(a)
dev.off()
...
a<- netAnalysis_signalingRole_heatmap(cellchat, signaling = pathways.show.all, pattern = "outgoing",width = 3, height = 15)
print(a)
rm(a)
dev.off()

pdf("selected_pathways_incoming_signaling_patterns_heatmap.pdf",width = 10, height = 10, paper = "special")
a<- netAnalysis_signalingRole_heatmap(cellchat, signaling = pathways.show.all, pattern = "incoming",width = 3, height = 15)
print(a)
rm(a)
dev.off()
dev.off()
...
pdf("communication_patterns_outgoing_heatmap.pdf",width = 10, height =12, paper = "special")
a<- identifyCommunicationPatterns(cellchat, pattern = "outgoing", k = nPatterns, width = 6, height = 12, font.size = 8)
print(a)
rm(a)
dev.off()
...
# dot plot
pdf("communication_patterns_outgoing_dotplot.pdf",width = 10, height = 2, paper = "special")
...
pdf("communication_patterns_incoming_heatmap.pdf",width = 10, height = 12, paper = "special")
a<- identifyCommunicationPatterns(cellchat, pattern = "incoming", k = nPatterns,width = 6, height = 12, font.size = 8)
print(a)
rm(a)
dev.off()
...
# dot plot
pdf("communication_patterns_incoming_dotplot.pdf",width = 8, height = 2, paper = "special")
...
saveRDS(cellchat, file = "cellchat_arterial_pericytes_adv_cellchat_object.rds")
