...
load("C:/Users/alex/Desktop/163k_endo_final/endo_163K_after_MAST_and_roc_analysis_data.RData")
DefaultAssay(lung) <- "RNA"
# set the name of the analyzed dataset
cell_type <- "endo_artery"

DefaultAssay(lung) <- "integrated"
# select the clusters for trajectory differential epxression analysis

selected_clusters <- c(0, 1, 12, 6, 9)
...
save.image(file="arterial_analysis_data.RData")
...
save.image("artery_trajectory.RData")
#----------------------------------------------------------------------
...
#SMOOTHED HEATMAP
png(filename = paste0(cell_type, "_trajectory_branch_markers.png"),width = 800*1,height = 800*3,res = 300)
...
#SMOOTHED HEATMAP
png(filename = paste0(cell_type, "_trajectory_branch_markers_hierachical.png"),width = 800*1,height = 800*3,res = 300)
x <- t(apply(res,1,function(x){scale(x,T,T)}))
#to_order <- apply(x,1,function(x){ mean( (1:length(x))[order(x,decreasing = T)][1] )})
#to_order <- apply( (res[,1:40]),1,function(x){ mean( (1:length(x))[order(x,decreasing = F)][1] )})
to_order <- apply(x,1,function(x){ which.max(x) })
...
# reorder the leaves of the dendrogram according to our needs. In the example we have got 7 leaves and flip 3 with 7.
a <- rev(which(gene_dendro1==5))
b <- which(gene_dendro1==c(4))
c <- rev(which(gene_dendro1==c(1)))
d <- rev(which(gene_dendro1==c(2)))
e <- which(gene_dendro1==c(3))


plot(rotate(gene_dendro, c(a,b, c, d, e)),cex = 0.5, hang = -1)
rect.hclust(rotate(gene_dendro, c(a,b, c, d, e)), k = k, border = "red")
a <-rotate(gene_dendro, c(a,b, c, d, e))

png(filename = paste0(cell_type, "_trajectory_branch_markers_reordered.png"),width = 800*1,height = 800*3,res = 300)
x <- t(apply(res,1,function(x){scale(x,T,T)}))
to_order <- apply(x,1,function(x){ mean( (1:length(x))[order(x,decreasing = T)][1] )})
...
#SMOOTHED HEATMAP
png(filename = paste0(cell_type, "_trajectory_branch_TFs.png"),width = 800*1,height = 800*3,res = 300)
x <- t(apply(res,1,function(x){scale(x,T,T)}))
#to_order <- apply(x,1,function(x){ mean( (1:length(x))[order(x,decreasing = T)][1] )})
#to_order <- apply( (res[,1:40]),1,function(x){ mean( (1:length(x))[order(x,decreasing = F)][1] )})
to_order <- apply(x,1,function(x){ which.max(x) })
...
#SMOOTHED HEATMAP
png(filename = paste0(cell_type, "_trajectory_branch_TFs_hierachical.png"),width = 800*1,height = 800*3,res = 300)
x <- t(apply(res,1,function(x){scale(x,T,T)}))
#to_order <- apply(x,1,function(x){ mean( (1:length(x))[order(x,decreasing = T)][1] )})
#to_order <- apply( (res[,1:40]),1,function(x){ mean( (1:length(x))[order(x,decreasing = F)][1] )})
to_order <- apply(x,1,function(x){ which.max(x) })
...
#SMOOTHED HEATMAP
png(filename = paste0(cell_type, "_trajectory_branch_coTFs.png"),width = 800*1,height = 800*3,res = 300)
x <- t(apply(res,1,function(x){scale(x,T,T)}))
#to_order <- apply(x,1,function(x){ mean( (1:length(x))[order(x,decreasing = T)][1] )})
#to_order <- apply( (res[,1:40]),1,function(x){ mean( (1:length(x))[order(x,decreasing = F)][1] )})
to_order <- apply(x,1,function(x){ which.max(x) })
...
#SMOOTHED HEATMAP
png(filename = paste0(cell_type, "_trajectory_branch_coTFs_hierachical.png"),width = 800*1,height = 800*3,res = 300)
x <- t(apply(res,1,function(x){scale(x,T,T)}))
#to_order <- apply(x,1,function(x){ mean( (1:length(x))[order(x,decreasing = T)][1] )})
#to_order <- apply( (res[,1:40]),1,function(x){ mean( (1:length(x))[order(x,decreasing = F)][1] )})
to_order <- apply(x,1,function(x){ which.max(x) })
...
#SMOOTHED HEATMAP
png(filename = paste0(cell_type, "_trajectory_branch_secr.png"),width = 800*1,height = 800*3,res = 300)
x <- t(apply(res,1,function(x){scale(x,T,T)}))
#to_order <- apply(x,1,function(x){ mean( (1:length(x))[order(x,decreasing = T)][1] )})
#to_order <- apply( (res[,1:40]),1,function(x){ mean( (1:length(x))[order(x,decreasing = F)][1] )})
to_order <- apply(x,1,function(x){ which.max(x) })
...
#SMOOTHED HEATMAP
png(filename = paste0(cell_type, "_trajectory_branch_secr_hierachical.png"),width = 800*1,height = 800*3,res = 300)
x <- t(apply(res,1,function(x){scale(x,T,T)}))
#to_order <- apply(x,1,function(x){ mean( (1:length(x))[order(x,decreasing = T)][1] )})
#to_order <- apply( (res[,1:40]),1,function(x){ mean( (1:length(x))[order(x,decreasing = F)][1] )})
to_order <- apply(x,1,function(x){ which.max(x) })
...
#SMOOTHED HEATMAP
png(filename = paste0(cell_type, "_trajectory_branch_CD.png"),width = 800*1,height = 800*3,res = 300)
x <- t(apply(res,1,function(x){scale(x,T,T)}))
#to_order <- apply(x,1,function(x){ mean( (1:length(x))[order(x,decreasing = T)][1] )})
#to_order <- apply( (res[,1:40]),1,function(x){ mean( (1:length(x))[order(x,decreasing = F)][1] )})
to_order <- apply(x,1,function(x){ which.max(x) })
...
#SMOOTHED HEATMAP
png(filename = paste0(cell_type, "_trajectory_branch_CD_hierachical.png"),width = 800*1,height = 800*3,res = 300)
x <- t(apply(res,1,function(x){scale(x,T,T)}))
#to_order <- apply(x,1,function(x){ mean( (1:length(x))[order(x,decreasing = T)][1] )})
#to_order <- apply( (res[,1:40]),1,function(x){ mean( (1:length(x))[order(x,decreasing = F)][1] )})
to_order <- apply(x,1,function(x){ which.max(x) })
...
#SMOOTHED HEATMAP
png(filename = paste0(cell_type, "_trajectory_branch_kinases.png"),width = 800*1,height = 800*3,res = 300)
x <- t(apply(res,1,function(x){scale(x,T,T)}))
#to_order <- apply(x,1,function(x){ mean( (1:length(x))[order(x,decreasing = T)][1] )})
#to_order <- apply( (res[,1:40]),1,function(x){ mean( (1:length(x))[order(x,decreasing = F)][1] )})
to_order <- apply(x,1,function(x){ which.max(x) })
...
#SMOOTHED HEATMAP
png(filename = paste0(cell_type, "_trajectory_branch_kinases_hierachical.png"),width = 800*1,height = 800*3,res = 300)
x <- t(apply(res,1,function(x){scale(x,T,T)}))
#to_order <- apply(x,1,function(x){ mean( (1:length(x))[order(x,decreasing = T)][1] )})
#to_order <- apply( (res[,1:40]),1,function(x){ mean( (1:length(x))[order(x,decreasing = F)][1] )})
to_order <- apply(x,1,function(x){ which.max(x) })
...
levels(temp) <- c("0",  "1", "12", "6", "9")
colors3 <- colors3[c(1, 2, 5, 3, 4),]

#3x9 inches
VlnPlot(temp, features = c("CLDN5"), cols = colors3$color, pt.size = 0)
...
write.csv(lung_cluster.markers, file="arterial_markers.csv")
...
levels(temp) <- c("9", "6", "12", "1", "0")
new_order <- c( "0",  "1", "12", "6", "9")
...
e <- e[!duplicated(e)]
#3x8 inches
#endo_artery_top5_markers_dotplot
